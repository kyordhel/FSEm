...
\begin{enumerate}
	\item{} [6pt] Alambre el circuito completo y combine el código de los \Cref{sec:appendix1,sec:appendix2,sec:appendix3,sec:appendix4,sec:appendix5} para poder controlar la intensidad del brillo del foco incandecente con la Raspberry Pi usando los valores tecleados en la consola (porentaje de 0--100\% de la potencia total).
