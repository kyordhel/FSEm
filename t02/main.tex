...
Lea detenidamente el Capítulo 1: Clean Code del libro homónimo de Robert C. Martin y escriba una breve síntesis de aproximadamente 250 palabras donde se discutan los puntos más relevantes presentados por el autor.
Ponga especial atención en
\begin{enumerate*}[label=\roman*\rpar]
	\item qué es el código limpio
	\item por qué es importante programar de forma ordenada
	y
	\item en qué se diferencia el código limpio de un mal código.
\end{enumerate*}
