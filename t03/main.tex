...
Lea detenidamente el Capítulo 2: \emph{Meaningful Names} del libro Clean Code de Robert C. Martin y escriba una breve síntesis de aproximadamente 250 palabras donde se discutan los puntos más relevantes presentados por el autor.
Ponga especial atención en
\begin{enumerate*}[label=\roman*\rpar]
	\item por qué es importante el cómo se nombran las cosas,
	\item cómo deben elegirse los nombres,
	y
	\item cómo afectan los nombres a la legibilidad del código.
\end{enumerate*}
